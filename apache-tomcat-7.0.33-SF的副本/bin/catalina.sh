...
JAVA_OPTS="-Xms2048m -XX:PermSize=128m -XX:MaxPermSize=128m  -Xss256k   -XX:+UseConcMarkSweepGC -XX:CMSFullGCsBeforeCompaction=5 -XX:+UseCMSCompactAtFullCollection"
# -----------------------------------------------------------------------------
